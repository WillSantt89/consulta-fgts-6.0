import React, { useState } from 'react';
    ...
    type BancoOption = 'todos' | 'facta' | 'vctex';

    const ConsultaIndividual: React.FC = () => {
      const [cpf, setCpf] = useState('');
      const [bancoSelecionado, setBancoSelecionado] = useState<BancoOption>('todos');
      ...
      // Função para mudar o banco selecionado
      const handleBancoChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        setBancoSelecionado(e.target.value as BancoOption);
      };
      
      // Função para obter o endpoint da API com base no banco selecionado
      const getApiEndpoint = (): string => {
        switch (bancoSelecionado) {
          case 'facta':
            return 'https://n8n-queue-2-n8n-webhook.igxlaz.easypanel.host/webhook/simulador/facta';
          case 'vctex':
            return 'https://santanacred-n8n-chatwoot.igxlaz.easypanel.host/webhook/vctex/consulta';
          case 'todos':
          default:
            return 'https://santanacred-n8n-chatwoot.igxlaz.easypanel.host/webhook/consulta';
        }
      };
      
      // Consulta a API selecionada
      const handleConsulta = async () => {
        ...
        try {
          ...
          // Obter o endpoint correto da API
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between mb-6">
                ...
                <div>
                  <div className="text-sm text-gray-500">Banco Consultado</div>
                  <div className="text-lg font-medium">
                    {bancoSelecionado === 'todos' ? 'Todos os Bancos' : 
                     bancoSelecionado === 'facta' ? 'Banco Facta' : 'Banco VCTEX'}
                  </div>
                </div>
                <div>
              ...
              <div className="mb-4">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  >
                    ...
                    <option value="facta">Banco Facta</option>
                    <option value="vctex">Banco VCTEX</option>
                  </select>
                </div>
              </div>
            ...
            {error ? (
              ...
              <div className="bg-white rounded-lg shadow p-8 flex flex-col items-center justify-center text-center h-full">
                ...
                <p className="text-gray-500 max-w-sm">
                  Digite um CPF válido, selecione o banco desejado e clique em "Consultar" para verificar o saldo disponível para saque FGTS.
                </p>
              </div>
            )}
          </div>
